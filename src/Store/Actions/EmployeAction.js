...
export const asyncforgetpassword = (email) => async (dispatch, getState) =>{
  ...
  try {
    const data = await axios.post("/employe/forget-password", email)
    dispatch(asyncCurrentEmploye())
...
export const asyncgetotp = (email) => async (dispatch, getState) =>{
   
  try {
    const data = await axios.post("employe/forget-link/:id", email)
    dispatch(asyncCurrentEmploye())
