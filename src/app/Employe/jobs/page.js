  ...
  return (
    <div className="">
      ...
      <div className="flex flex-col">
        ...
        <h2 className="text-2xl text-gray-800 text-center">Hi, You have not posted any job yet!</h2>
        <h3 className="text-xl text-gray-600 text-center mt-3 mb-5">Post a job and find the best candidate.</h3>
      ...
      <div className="w-full flex flex-col items-center justify-center">
        {employe && employe.jobs.map((job) => (
          <EmployBigjob key={job._id} data={job} />
        ))}
      </div>
    </div>
  );
