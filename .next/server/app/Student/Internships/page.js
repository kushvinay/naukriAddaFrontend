...
const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 99664)), "C:\\Users\\AVS\\Desktop\\naukriAddaFrontend\\src\\app\\Student\\Internships\\page.js"],
...
const originalPathname = "/Student/Internships/page";
const __next_app__ = {
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 22337))
...
;// CONCATENATED MODULE: ./src/app/components/InternshipContant.js
...
const InternshipContant = ()=>{
    ...
    let { isAuthenticated, student, internships } = (0,lib.useSelector)((state)=>state.StudentSlice);
    // useEffect(() => {
    ...
    const getMoreinternship = async ()=>{
        ...
        //   // AddmoreinState();
        // }
        await dispatch((0,StudentActions/* asyncAddInternship */.BD)(internships.length));
    ...
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)(jsx_runtime_.Fragment, {
        children: [
            ...
            /*#__PURE__*/ jsx_runtime_.jsx((dist_default()), {
                ...
                children: internships?.map((internship)=>/*#__PURE__*/ jsx_runtime_.jsx(Biginterncard/* default */.Z, {
                        data: internship
                    }, internship._id))
            })
        ]
...
/* harmony default export */ const components_InternshipContant = (InternshipContant);

;// CONCATENATED MODULE: ./src/app/Student/Internships/page.js
// "use client"
...
const Internships = ()=>{
    ...
    const dispatch = (0,lib.useDispatch)();
    let { isAuthenticated, student } = (0,lib.useSelector)((state)=>state.StudentSlice);
    (0,react_.useEffect)(()=>{
        if (!isAuthenticated && !student) router.push("/Studentlogin");
    }, [
        isAuthenticated
    ...
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
        ...
        children: [
            /*#__PURE__*/ jsx_runtime_.jsx("h1", {
                className: "text-2xl sm:text-3xl lg:text-4xl font-semibold text-center my-6 sm:my-10 text-gray-700",
                children: "INTERNSHIPS"
            }),
            /*#__PURE__*/ jsx_runtime_.jsx("div", {
                className: "flex flex-col items-center",
                children: /*#__PURE__*/ jsx_runtime_.jsx(components_InternshipContant, {})
            })
        ]
    });
};
...
var __webpack_exports__ = __webpack_require__.X(0, [3587,8995,6648,2451,4731,1314,8468,6311,466,6229,9056], () => (__webpack_exec__(9149)));
